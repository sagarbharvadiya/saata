                    ...
                    <form className='contact_form'>
                        ...
                        <div className='input_wrapper'>
                            <div className='input_field'>
                                <input type="text" class="inner-input" placeholder="Your Name" name="user_name" required=""/>
                               <i className='fa-solid fa-user input-icons'></i>
                            </div>
                            <div className='input_field'>
                                <input type="email" class="inner-input" placeholder="Email Address" name="user_email" required=""/>
